# 1 "d:\\\320\324\304\334\262\342\312\324\\\324\306\277\274\312\324c05\\teachermarkexam\\\\combined_TeacherMarkExam.c"
...
# 1 "d:\\\320\324\304\334\262\342\312\324\\\324\306\277\274\312\324c05\\teachermarkexam\\\\combined_TeacherMarkExam.c" 2
...
# 2 "d:\\\320\324\304\334\262\342\312\324\\\324\306\277\274\312\324c05\\teachermarkexam\\\\combined_TeacherMarkExam.c" 2
...
# 3 "d:\\\320\324\304\334\262\342\312\324\\\324\306\277\274\312\324c05\\teachermarkexam\\\\combined_TeacherMarkExam.c" 2
...
Action()
{
	...
	if(strcmp(lr_eval_string("{HttpCode}"),"200")==0){
		lr_end_transaction("queryExaminationList", 0);
	}
	else{
		lr_output_message("result:%s",lr_eval_string("{result_convert}"));
		lr_end_transaction("queryExaminationList",1);
	}
	...
	lr_convert_string_encoding(lr_eval_string("{result}"),"utf-8",0,"result_convert");
	if(strcmp(lr_eval_string("{HttpCode}"),"200")==0){
		lr_end_transaction("getToMarkingInfo", 0);
	}
	else{
		lr_output_message("result:%s",lr_eval_string("{result_convert}"));
		lr_end_transaction("getToMarkingInfo",1);
	}
	...
	lr_convert_string_encoding(lr_eval_string("{result}"),"utf-8",0,"result_convert");
	if(strcmp(lr_eval_string("{HttpCode}"),"200")==0){
		lr_end_transaction("getExamResultDetail", 0);
	}
	else{
		lr_output_message("result:%s",lr_eval_string("{result_convert}"));
		lr_end_transaction("getExamResultDetail",1);
	}
...
# 154 "Action.c"
	...
	if(strcmp(lr_eval_string("{HttpCode}"),"200")==0){
		lr_end_transaction("PaperPage", 0);
	}
	else{
		lr_output_message("result:%s",lr_eval_string("{result_convert}"));
		lr_end_transaction("PaperPage",1);
	}
	...
	lr_convert_string_encoding(lr_eval_string("{result}"),"utf-8",0,"result_convert");
	if(strcmp(lr_eval_string("{HttpCode}"),"200")==0){
		lr_end_transaction("markExamResultAnswer_blank", 0);
	}
	else{
		lr_output_message("result:%s",lr_eval_string("{result_convert}"));
		lr_end_transaction("markExamResultAnswer_blank",1);
	}
	...
	lr_convert_string_encoding(lr_eval_string("{result}"),"utf-8",0,"result_convert");
	if(strcmp(lr_eval_string("{HttpCode}"),"200")==0){
		lr_end_transaction("getToMarkingInfo_refresh", 0);
	}
	else{
		lr_output_message("result:%s",lr_eval_string("{result_convert}"));
		lr_end_transaction("getToMarkingInfo_refresh",1);
	}
	...
	lr_convert_string_encoding(lr_eval_string("{result}"),"utf-8",0,"result_convert");
	if(strcmp(lr_eval_string("{HttpCode}"),"200")==0){
		lr_end_transaction("markExamResultAnswer_QandA", 0);
	}
	else{
		lr_output_message("result:%s",lr_eval_string("{result_convert}"));
		lr_end_transaction("markExamResultAnswer_QandA",1);
	}
...
# 4 "d:\\\320\324\304\334\262\342\312\324\\\324\306\277\274\312\324c05\\teachermarkexam\\\\combined_TeacherMarkExam.c" 2
...
vuser_end()
{
    ...
    if (strcmp(lr_eval_string("{HttpCode}"),"302")==0) {
		...
		lr_end_transaction("logout", 1);
	}
	return 0;
}
# 5 "d:\\\320\324\304\334\262\342\312\324\\\324\306\277\274\312\324c05\\teachermarkexam\\\\combined_TeacherMarkExam.c" 2
